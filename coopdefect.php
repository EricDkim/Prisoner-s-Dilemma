<?php
   ...
   //USER'S CLASS IS PLAYING RANDOM
			...
			echo "NEVER entered!";
				...
				if (!is_null($row['p1_choice']))  //opponent has already made a decision
				{
					...
					if ($_GET["decision"] == 0 && $row['p1_choice'] == 0)
					{
						...
						$query = "INSERT INTO random_history (player1, player2, player1_choice, player2_choice, player1_score, player2_score) 
						VALUES ('".$row['p1'] ."','".$row['p2']."','coop','coop', '3', '3')";
						$result = mysqli_query($dbc, $query);
					...
					elseif ($_GET["decision"] == 0 && $row['p1_choice'] == 1)
					{
						...
						$query = "INSERT INTO random_history (player1, player2, player1_choice, player2_choice, player1_score, player2_score) 
						VALUES ('".$row['p1'] ."','".$row['p2']."','defect','coop', '5', '0')";
						$result = mysqli_query($dbc, $query);
					...
					elseif ($_GET["decision"] == 1 && $row['p1_choice'] == 0)
					{
						...
						$query = "INSERT INTO random_history (player1, player2, player1_choice, player2_choice, player1_score, player2_score) 
						VALUES ('".$row['p1'] ."','".$row['p2']."','coop','defect', '0', '5')";
						$result = mysqli_query($dbc, $query);
					...
					elseif ($_GET["decision"] == 1 && $row['p1_choice'] == 1)
					{
						...
						$query = "INSERT INTO random_history (player1, player2, player1_choice, player2_choice, player1_score, player2_score) 
						VALUES ('".$row['p1'] ."','".$row['p2']."','defect','defect', '1, '1')";
						$result = mysqli_query($dbc, $query);
