			  ...
			  "<table class='table table-hover table-bordered table-striped' border=1 id='inner'> ".
					...
					if (IsSet($_POST["course"]) && ($_POST["course"] == "iterate_history" || $_POST["course"] == "random_history"))  //set the appropriate header for history or not history tables
					{
						echo
                            ...
                            "<tr>".                
                            */
                                "<th colspan='1' class='reportheader'>GAME</th>".
                                "<th colspan='1' class='reportheader'>PLAYER 1</th>".
                                "<th colspan='1' class='reportheader'>PLAYER 2</th>".
                                "<th colspan='2' class='reportheader'>ROUND 1</th>".
                                "<th colspan='2' class='reportheader'>ROUND 2</th>".
                                "<th colspan='2' class='reportheader'>ROUND 3</th>".
                                "<th colspan='2' class='reportheader'>ROUND 4</th>".
                                "<th colspan='2' class='reportheader'>ROUND 5</th>".
                                "<th colspan='1' class='reportheader'>PLAY</th>".
                            "</tr>".
                            "<tr>".
                                "<th colspan='1' class='reportheader'>ID</th>".
                                "<th colspan='1' class='reportheader'>NAME TAG</th>".
                                "<th colspan='1' class='reportheader'>NAME TAG</th>".
                                "<th colspan='1' class='reportheader'>P-1 points</th>".
                                "<th colspan='1' class='reportheader'>P-2 points</th>".
                                "<th colspan='1' class='reportheader'>P-1 points</th>".
                                "<th colspan='1' class='reportheader'>P-2 points</th>".
                                "<th colspan='1' class='reportheader'>P-1 points</th>".
                                "<th colspan='1' class='reportheader'>P-2 points</th>".
                                ...
                                "<th colspan='1' class='reportheader'>P-1 points</th>".
                                "<th colspan='1' class='reportheader'>P-2 points</th>".                                
                                "<th colspan='1' class='reportheader'>DAY-TIME</th>";
                            //"</tr>";                                                
					...
					{
						echo
							"<th class='reportheader'>User Name</th> ".
							"<th class='reportheader'>Last Name</th> ".
							"<th class='reportheader'>First Name</th> ".
							"<th class='reportheader'>Score</th> ".
							"<th class='reportheader'>Course</th> ".
							"<th class='reportheader'>Section</th> ";
					}
						echo "</tr> ";
					...
					{
						$query = 'select usernames, last_name, first_name, score, course, section from users u left join totals ts on u.id = ts.users_id WHERE course LIKE \''.
