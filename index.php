...
<body class="indexbody">
    ...
    <div class="container indexblock">
		<div class="jumbotron" id="indexjumbo">
            <!-- jumbotron are assumed to cover the entire 12 columns and don't need the sm lg xs etc-->
			<center>
				<h1 class="indextitle"><span class="label label-default">Prisoner's Dilemma</span></h1>
    	       <br/>
                ...
                <form class="form-horizontal" id='indexform' role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        $debug = new PHPDebug();
                        //$debug->debug("Query at index.php :  '$sqlProcess' ");           
                            ...
                            {                      
                                ...
                                //$sqlProcess = "DELETE FROM login_history WHERE id = '$cp';  INSERT login_history (id,log_in,isAdmin) VALUES ('$cp', NOW(), 0)";            
                                //$update_status_query = mysqli_query($dbc, $sqlProcess);            
...
-->
	...
	<div class="container">
		<p class="pull-left">			
			<a href="https://GGC.edu"> Georgia Gwinnett College ITEC Department</a>
			&copy 2016                    
		</p>
	</div>
